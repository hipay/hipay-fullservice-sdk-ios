# Contributing to the HiPay Fullservice SDK for iOS

Contributions to the HiPay Fullservice SDK for iOS should be made via GitHub [pull
...
The HiPay Fullservice SDK for iOS is released under an [Apache
2.0][project-license] license. Any code you submit will be
released under that license.

[project-license]: LICENSE.md

[pull-requests]: https://github.com/hipay/hipay-fullservice-sdk-ios/pulls
[issues]: https://github.com/hipay/hipay-fullservice-sdk-ios/issues