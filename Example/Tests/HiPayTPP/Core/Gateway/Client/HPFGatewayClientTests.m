...
#import <HiPayTPP/HPFPaymentPageRequestSerializationMapper.h>
#import <HiPayTPP/HPFOrderRequestSerializationMapper.h>
#import <HiPayTPP/HPFArrayMapper.h>
#import <HiPayTPP/HPFTransactionCallbackMapper.h>
...
- (void)testPerformRequestHTTPError
{
    ...
    NSError *gatewayError = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:0 userInfo:@{}];
...
{
    XCTestExpectation *expectation = [self expectationWithDescription:@"Loading request"];
    NSError *theError = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:0 userInfo:@{}];
...
{
    NSError *error1 = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeAPICheckout userInfo:@{HPFErrorCodeAPICodeKey: @(3010003)}];
    
    NSError *notFinalError = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeAPICheckout userInfo:@{HPFErrorCodeAPICodeKey: @(3010002)}];
