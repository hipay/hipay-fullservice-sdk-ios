...
#import <HiPayFullservice/HPFExpiryDateFormatter.h>

@interface HPFExpiryDateFormatterTests : XCTestCase
{
    OCMockObject *mockedFormatter;
    HPFExpiryDateFormatter *formatter;
}

@end

@implementation HPFExpiryDateFormatterTests

- (void)setUp {
    [super setUp];
    
    mockedFormatter = [OCMockObject partialMockForObject:[[HPFExpiryDateFormatter alloc] init]];
    formatter = (HPFExpiryDateFormatter *)mockedFormatter;
}
