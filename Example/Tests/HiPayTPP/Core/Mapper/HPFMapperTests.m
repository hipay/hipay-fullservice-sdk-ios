...
@interface HPFMapperTests : XCTestCase

@end

@implementation HPFMapperTests
...
- (void)testInit {
    ...
    HPFAbstractMapper *mapper = [[HPFAbstractMapper alloc] initWithRawData:rawData];
...
- (void)testInitNilData {
    ...
    HPFAbstractMapper *mapper = [[HPFAbstractMapper alloc] initWithRawData:nil];
...
- (void)testValues {
    ...
    HPFAbstractMapper *mapper = [OCMockObject partialMockForObject:[[HPFAbstractMapper alloc] initWithRawData:rawData]];
    
    [((HPFAbstractMapper *)[[(OCMockObject *)mapper expect] andReturn:rawData]) rawData];
...
- (void)testInteger
{
    ...
    OCMockObject *mapper = [OCMockObject partialMockForObject:[[HPFAbstractMapper alloc] initWithRawData:@{}]];
    ...
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test1"], 11);
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test2"], 11);
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test3"], 1898981);
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test4"], 1898981);
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test5"], 0);
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test6"], 0);
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test7"], 0);
    XCTAssertEqual([((HPFAbstractMapper *) mapper) getIntegerForKey:@"test8"], 0);
...
{
    OCMockObject *mockedMapper = [OCMockObject partialMockForObject:[[HPFAbstractMapper alloc] initWithRawData:@{}]];
    HPFAbstractMapper *mapper = (HPFAbstractMapper *)mockedMapper;
...
- (void)testEnumValues
{
    typedef NS_ENUM(NSInteger, HPFTestEnumValue) {
        
        HPFTestEnumValueUnknown,
        HPFTestEnumValueRed,
        HPFTestEnumValueWhite,
        HPFTestEnumValueBlue,
        
    };
    
    NSDictionary *values = @{@"red": @(HPFTestEnumValueRed),
                             @"blue": @(HPFTestEnumValueBlue),
                             @"white": @(HPFTestEnumValueWhite)};
    ...
    XCTAssertEqual([mapper getIntegerEnumValueWithKey:@"test1" defaultEnumValue:HPFTestEnumValueUnknown allValues:values], HPFTestEnumValueWhite);
    XCTAssertEqual([mapper getIntegerEnumValueWithKey:@"test2" defaultEnumValue:HPFTestEnumValueUnknown allValues:values], HPFTestEnumValueBlue);
    XCTAssertEqual([mapper getIntegerEnumValueWithKey:@"test3" defaultEnumValue:HPFTestEnumValueUnknown allValues:values], HPFTestEnumValueRed);
    XCTAssertEqual([mapper getIntegerEnumValueWithKey:@"test4" defaultEnumValue:HPFTestEnumValueUnknown allValues:values], HPFTestEnumValueUnknown);
    XCTAssertEqual([mapper getIntegerEnumValueWithKey:@"test5" defaultEnumValue:HPFTestEnumValueUnknown allValues:values], HPFTestEnumValueUnknown);
    XCTAssertEqual([mapper getIntegerEnumValueWithKey:@"test6" defaultEnumValue:HPFTestEnumValueUnknown allValues:values], HPFTestEnumValueUnknown);
...
{
    HPFAbstractMapper *mapper = [[HPFAbstractMapper alloc] initWithRawData:@{}];
