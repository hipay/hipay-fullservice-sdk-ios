            ...
            if (error != nil) {
                ...
                if (JSONError == nil) {
                    ...
                    if (NSLocationInRange(clientResponse.statusCode, (NSRange){400, 499})) {
                        responseError = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeHTTPClient userInfo:@{NSLocalizedDescriptionKey: HPFErrorCodeHTTPClientDescription, HPFErrorCodeHTTPStatusCodeKey: @(clientResponse.statusCode)}];
                    }
                    
                    else if (NSLocationInRange(clientResponse.statusCode, (NSRange){500, 599})) {
                        responseError = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeHTTPServer userInfo:@{NSLocalizedDescriptionKey: HPFErrorCodeHTTPServerDescription, HPFErrorCodeHTTPStatusCodeKey: @(clientResponse.statusCode)}];
                    }
                ...
                // Content not parsable, server error
                    ...
                    completionBlock(nil, [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeHTTPServer userInfo:@{NSUnderlyingErrorKey: JSONError, NSLocalizedDescriptionKey: HPFErrorCodeHTTPServerDescription, HPFErrorCodeHTTPPlainResponseKey: [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding], HPFErrorCodeHTTPStatusCodeKey: @([(NSHTTPURLResponse *)response statusCode])}]);
                }
            }
            
            else {
                completionBlock(nil, [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeHTTPOther userInfo:@{NSLocalizedDescriptionKey: HPFErrorCodeHTTPOtherDescription}]);
            }
        }
