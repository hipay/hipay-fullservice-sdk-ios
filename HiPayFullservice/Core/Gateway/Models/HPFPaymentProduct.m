...
NSString *_Nonnull const HPFPaymentProductCodeAmericanExpress =
    @"american-express";
...
NSString *_Nonnull const HPFPaymentProductCodeDexiaDirectNet =
    @"dexia-directnet";
...
NSString *_Nonnull const HPFPaymentProductCodeKlarnacheckout =
    @"klarnacheckout";
...
NSString *_Nonnull const HPFPaymentProductCodeSofortUberweisung =
    @"sofort-uberweisung";
NSString *_Nonnull const HPFPaymentProductCodeTarjetaShopping =
    @"tarjeta-shopping";
NSString *_Nonnull const HPFPaymentProductCodeVisa = @"visa";
NSString *_Nonnull const HPFPaymentProductCodeWebmoneyTransfer =
    @"webmoney-transfer";
...
NSString *_Nonnull const HPFPaymentProductCodeBancoDoBrasil =
    @"banco-do-brasil";
NSString *_Nonnull const HPFPaymentProductCodeBBVABancomer = @"bbva-bancomer";
NSString *_Nonnull const HPFPaymentProductCodeBoletoBancario =
    @"boleto-bancario";
...
NSString *_Nonnull const HPFPaymentProductCodeSantanderHomeBanking =
    @"santander-home-banking";

NSString *_Nonnull const HPFPaymentProductCodeApplePay = @"apple-pay";

NSString *_Nonnull const HPFPaymentProductCategoryCodeCreditCard =
    @"credit-card";
NSString *_Nonnull const HPFPaymentProductCategoryCodeDebitCard = @"debit-card";
NSString *_Nonnull const HPFPaymentProductCategoryCodeRealtimeBanking =
    @"realtime-banking";
NSString *_Nonnull const HPFPaymentProductCategoryCodeEWallet = @"ewallet";

@implementation HPFPaymentProduct

+ (HPFSecurityCodeType)securityCodeTypeForPaymentProductCode:
    (NSString *)paymentProductCode {
  if ([paymentProductCode isEqualToString:HPFPaymentProductCodeVisa] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeMasterCard] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeDiners] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeCB] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeDiscover] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeElo] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeAura] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeNaranja] ||
      [paymentProductCode
          isEqualToString:HPFPaymentProductCodeTarjetaShopping]) {
    return HPFSecurityCodeTypeCVV;
  }

  else if ([paymentProductCode
               isEqualToString:HPFPaymentProductCodeAmericanExpress]) {
    return HPFSecurityCodeTypeCID;
  }

  else if ([paymentProductCode isEqualToString:HPFPaymentProductCodeBCMC] ||
...
+ (BOOL)isDSP2CompatiblePaymentProductCode:(NSString *)paymentProductCode {
  if (paymentProductCode) {
    return (
        [paymentProductCode
            caseInsensitiveCompare:HPFPaymentProductCodeMasterCard] ==
            NSOrderedSame ||
        [paymentProductCode caseInsensitiveCompare:HPFPaymentProductCodeVisa] ==
            NSOrderedSame ||
        [paymentProductCode
            caseInsensitiveCompare:HPFPaymentProductCodeMaestro] ==
            NSOrderedSame ||
        [paymentProductCode caseInsensitiveCompare:HPFPaymentProductCodeCB] ==
            NSOrderedSame ||
        [paymentProductCode
            caseInsensitiveCompare:HPFPaymentProductCodeAmericanExpress] ==
            NSOrderedSame ||
        [paymentProductCode caseInsensitiveCompare:HPFPaymentProductCodeBCMC] ==
            NSOrderedSame);
  } else {
    return false;
  }
...
+ (BOOL)isPaymentCardStorageEnabledForPaymentProductCode:
    (NSString *)paymentProductCode {
  if ([paymentProductCode isEqualToString:HPFPaymentProductCodeBCMC] ||
      [paymentProductCode isEqualToString:HPFPaymentProductCodeMaestro]) {
    return NO;
  }
...
+ (BOOL)isPaymentProductCode:(NSString *)domesticPaymentProductCode
    domesticNetworkOfPaymentProductCode:(NSString *)paymentProductCode {
...
- (instancetype)initWithGroupedProducts:(NSSet<NSString *> *)paymentProducts {
  ...
  if (self) {
    ...
    _paymentProductDescription = NSLocalizedStringFromTableInBundle(
        @"PAYMENT_PRODUCT_GROUP_PAYMENT_CARD", @"Core",
        [NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]]
                                     pathForResource:@"HPFCoreLocalization"
                                              ofType:@"bundle"]],
        nil);
...
+ (NSString *)productCodeForAPIBrand:(NSString *)brand {
  static NSDictionary<NSString *, NSString *> *brandMap;
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    brandMap = @{
      @"visa":             HPFPaymentProductCodeVisa,
      @"mastercard":       HPFPaymentProductCodeMasterCard,
      @"american express": HPFPaymentProductCodeAmericanExpress,
      @"maestro":          HPFPaymentProductCodeMaestro,
      @"cb":               HPFPaymentProductCodeCB,
      @"bcmc":             HPFPaymentProductCodeBCMC,
      @"diners":           HPFPaymentProductCodeDiners,
      @"discover":         HPFPaymentProductCodeDiscover,
    };
  });

  NSString *lowered = brand.lowercaseString;
  NSString *mapped = brandMap[lowered];
  if (mapped) return mapped;

  return [lowered stringByReplacingOccurrencesOfString:@" " withString:@"-"];
}
