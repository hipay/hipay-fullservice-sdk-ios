...
- (NSDictionary *)serializedRequest
{
    ...
    [result mergeDictionary:[[HPTCustomerInfoRequestSerializationMapper mapperWithRequest:[self.request valueForKey:@"customer"]] serializedRequest] withPrefix:nil];
...
- (NSString *)getOperation
{
    ...
    if (operation != nil) {
        switch (operation.integerValue) {
            case HPTOrderRequestOperationSale:
                return @"Sale";
                
            case HPTOrderRequestOperationAuthorization:
