...
#import <HiPayTPP/HPFAbstractClient+Private.h>
...
- (void)testGenerateToken
{
    ...
    NSError *error = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeHTTPOther userInfo:@{}];
    ...
    }] andReturn:request] performRequestWithMethod:HPFHTTPMethodPost path:@"token/create" parameters:parameters completionHandler:OCMOCK_ANY];
...
- (void)testGenerateTokenWithoutSecurityCode
{
    ...
    }] performRequestWithMethod:HPFHTTPMethodPost path:@"token/create" parameters:paramtersNoCVC completionHandler:OCMOCK_ANY];
...
- (void)testUpdateToken
{
    ...
    }] andReturn:request] performRequestWithMethod:HPFHTTPMethodPost path:@"token/update" parameters:HTTPParameters completionHandler:OCMOCK_ANY];
...
- (void)testLookupPaymentCardWithToken
{
    ...
    }] andReturn:request] performRequestWithMethod:HPFHTTPMethodGet path:@"token/b57dad30b32a0026bd036b359cf70a80436a3b10" parameters:@{@"request_id": requestID} completionHandler:OCMOCK_ANY];
...
- (void)testManageRequestError
{
    ...
    NSError *HTTPError = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeHTTPClient userInfo:@{}];
    NSError *secureVaultError = [NSError errorWithDomain:HPFHiPayTPPErrorDomain code:HPFErrorCodeAPIOther userInfo:@{}];
...
- (void)testManageRequestErrorMalformedResponse
{
    ...
    [secureVaultClient manageRequestWithHTTPResponse:[[HPFHTTPResponse alloc] initWithStatusCode:200 body:rawData] error:nil andCompletionHandler:^(HPFPaymentCardToken *cardToken, NSError *error) {
        ...
        XCTAssertNil(cardToken);
        XCTAssertEqualObjects(error.domain, HPFHiPayTPPErrorDomain);
