//
//  HPFHostedPaymentPageMapperTests.m
//  HiPayFullservice
//
...
@interface HPFHostedPaymentPageMapperTests : XCTestCase
{
...
@implementation HPFHostedPaymentPageMapperTests
...
- (void)testInitWithWrongData
{
    ...
    XCTAssertNil([[HPFHostedPaymentPageMapper alloc] initWithRawData:rawData]);
}
...
- (void)mockOrder
{
    ...
    id orderClassMock = OCMClassMock([HPFOrderMapper class]);
...
- (void)testMapping
{
    ...
    // Class mock
    OCMockObject *mockedMapper = [OCMockObject partialMockForObject:[[HPFHostedPaymentPageMapper alloc] initWithRawData:rawData]];
    HPFHostedPaymentPageMapper *mapper = (HPFHostedPaymentPageMapper *)mockedMapper;
    ...
    HPFHostedPaymentPage *object = mapper.mappedObject;
