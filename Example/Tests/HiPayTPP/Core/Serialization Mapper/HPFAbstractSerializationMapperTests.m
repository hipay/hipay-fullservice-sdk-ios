//
//  HPFAbstractSerializationMapperTests.m
//  HiPayTPP
//
...
@interface HPFAbstractSerializationMapperTests : XCTestCase
{
    OCMockObject *mockedRequest;
    OCMockObject *mockedMapper;
    HPFAbstractSerializationMapper *mapper;
}

@end

@implementation HPFAbstractSerializationMapperTests

- (void)setUp {
    [super setUp];

    mockedRequest = [OCMockObject mockForClass:[NSObject class]];
    mockedMapper = [OCMockObject partialMockForObject:[HPFAbstractSerializationMapper mapperWithRequest:mockedRequest]];
    mapper = (HPFAbstractSerializationMapper *)mockedMapper;
}
...
- (void)testInitNil {
    XCTAssertNil([HPFAbstractSerializationMapper mapperWithRequest:nil]);
}
...
{
    XCTAssertEqualObjects([HPFAbstractSerializationMapper formatAmountNumber:@45], @"45.00");
    XCTAssertEqualObjects([HPFAbstractSerializationMapper formatAmountNumber:@45.12], @"45.12");
    XCTAssertEqualObjects([HPFAbstractSerializationMapper formatAmountNumber:@45.125457], @"45.1254");
}
