...
typedef NS_ENUM(NSInteger, HPTErrorAPIReason) {
    ...
    HPTErrorAPIMethodNotAllowedGateway = 1010001,
    HPTErrorAPIInvalidParameter = 1010002,
    HPTErrorAPIMethodNotAllowedSecureVault = 1010003,
    HPTErrorAPIInvalidCardToken = 1012003,
