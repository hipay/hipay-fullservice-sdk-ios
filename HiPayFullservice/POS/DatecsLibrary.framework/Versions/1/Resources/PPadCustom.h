...
//  Copyright (c) 2013 SepaSoft Development. All rights reserved.
//
...
//- barcodeData (event)
//  ean13 upc-a qr 417 ean128 code39
...
-(void)receivedLogLine:(NSString *)logLine;
...
@private
    ...
    EASession *tlsSession;
    NSInputStream *inStream;
    NSOutputStream *outStream;
    bool accConnected;
    NSMutableArray *messageQueue;
    
    uint8_t command[2048];
    uint16_t collectedLength;
    uint16_t expectedLength;
    uint8_t currentCommandId;
    uint8_t currentResultCode;
    bool waitingForNewCommand;
    bool screenIsEnabled;
    bool barcodeScanning;
    NSMutableData * sendBuffer;
    NSNumber* sendEndBufferPointer;
    uint32_t expectedLWPOSLength;
    
    //CkoSocket *socket;
    NSString *previousSSID;
    NSMutableArray *delegates;
    
    bool waitingForBattery;
    int batteryCapacity;
